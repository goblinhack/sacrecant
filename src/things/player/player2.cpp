...
void tp_player2_on_spawned(Gamep g, Levelsp v, Levelp l, Thingp me, ThingEvent *e_maybe_null)
{
  TRACE();
...
auto tp_player2_detail_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  ...
  return                                                                                                                          //
      ...
      UI_INFO2_FMT_STR "Although you still have the much needed fireball weapon, it receives a damage boost.\n"                   //
      ...
      UI_INFO5_FMT_STR "Combine this with attack bonuses, this wizard will fight well, while they live.\n";                       //
}
