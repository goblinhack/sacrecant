...
[[nodiscard]] static auto tp_staff_fire_get_weapon_list(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::vector< Tpp >
{
  TRACE();
...
[[nodiscard]] auto tp_load_staff_fire() -> bool
{
  ...
  thing_get_weapon_list_set(tp, tp_staff_fire_get_weapon_list);
