...
static auto tp_staff_energy_description_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  TRACE();
...
static auto tp_staff_energy_detail_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  TRACE();
...
[[nodiscard]] auto tp_load_staff_energy() -> bool
{
  ...
  auto *tp   = tp_load("staff_energy"); // keep as string for scripts
  ...
  tp_name_a_or_an_set(tp, "a staff of energy");
  tp_name_apostrophize_set(tp, "staff of energy's");
  tp_name_long_set(tp, "staff of energy");
  tp_name_pluralize_set(tp, "staves of energy");
  tp_name_short_set(tp, "staff of energy");
