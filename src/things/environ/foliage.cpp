...
static auto tp_foliage_description_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  TRACE();
...
static auto tp_foliage_z_depth_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> MapZDepthType
{
  TRACE();
