...
static auto tp_sac_unlucky_detail_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  ...
  return                                                                                                                      //
      UI_INFO1_FMT_STR "It's just not your day, ever, with this sacrifice.\n"                                                 //
      UI_INFO2_FMT_STR "In detail, your luck is heavily decreased, which has an impact on many things, like the chance of:\n" //
      UI_INFO3_FMT_STR "- volatile treasure chests\n"                                                                         //
      UI_INFO4_FMT_STR "- escaping engulfment\n"                                                                              //
      UI_INFO5_FMT_STR "- landing in lava \n"                                                                                 //
      UI_INFO6_FMT_STR "- teleporting into danger\n"                                                                          //
      UI_INFO7_FMT_STR "- and more...\n";                                                                                     //
}
