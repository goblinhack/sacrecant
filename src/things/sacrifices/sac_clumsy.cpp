...
static auto tp_sac_clumsy_detail_get(Gamep g, Levelsp v, Levelp l, Thingp me) -> std::string
{
  ...
  return                                                                                                                                       //
      UI_INFO1_FMT_STR "You'd trip over your own feet if you hadn't already stumbled into a chasm with this sacrifice.\n"                      //
      UI_INFO2_FMT_STR "In detail, your dexterity and defence is heavily decreased, which has an impact on many things, like the chance of:\n" //
      UI_INFO3_FMT_STR "- avoiding traps\n"                                                                                                    //
      UI_INFO4_FMT_STR "- escaping spiderwebs\n"                                                                                               //
      UI_INFO5_FMT_STR "- and more...\n";                                                                                                      //
}
