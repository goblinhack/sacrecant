...
auto operator>>(std::istream &in, Bits< Config & > my) -> std::istream &
{
  ...
  //
  {
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Config, key_abort)) {
      game_load_error = "Config structure changed: offsetof(Config, key_abort))";
      return in;
    }
    in >> bits(tmp);
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Config, key_learn)) {
      game_load_error = "Config structure changed: offsetof(Config, key_learn))";
      return in;
    }
    in >> bits(tmp);
...
auto operator>>(std::istream &in, Bits< class Game & > my) -> std::istream &
{
  ...
  //
  {
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _distance_throw)) {
      game_load_error = "thing structure changed: offsetof(Thing, _distance_throw)";
      return in;
    }
    in >> bits(tmp);
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _is_hidden)) {
      game_load_error = "thing structure changed: offsetof(Thing, _is_hidden)";
      return in;
    }
    in >> bits(tmp);
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _noise)) {
      game_load_error = "thing structure changed: offsetof(Thing, _noise)";
      return in;
    }
    in >> bits(tmp);
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _spell_cost)) {
      game_load_error = "thing structure changed: offsetof(Thing, _spell_cost)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _crit_roll)) {
      game_load_error = "thing structure changed: offsetof(Thing, _crit_roll)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _fumble_roll)) {
      game_load_error = "thing structure changed: offsetof(Thing, _fumble_roll)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _mana_max)) {
      game_load_error = "thing structure changed: offsetof(Thing, _mana_max)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _mana)) {
      game_load_error = "thing structure changed: offsetof(Thing, _mana)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _sac_points_max)) {
      game_load_error = "thing structure changed: offsetof(Thing, _sac_points_max)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _sac_points)) {
      game_load_error = "thing structure changed: offsetof(Thing, _sac_points)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _jump_attack_pct_chance)) {
      game_load_error = "thing structure changed: offsetof(Thing, _jump_attack_pct_chance)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _items_collected_max)) {
      game_load_error = "thing structure changed: offsetof(Thing, _items_collected_max)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _attack_count_per_tick)) {
      game_load_error = "thing structure changed: offsetof(Thing, _attack_count_per_tick)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _hearing_threshold)) {
      game_load_error = "thing structure changed: offsetof(Thing, _hearing_threshold)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _distance_throw)) {
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _charge_count)) {
      game_load_error = "thing structure changed: offsetof(Thing, _charge_count)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _distance_avoid_target)) {
      game_load_error = "thing structure changed: offsetof(Thing, _distance_avoid_target)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _stamina)) {
      game_load_error = "thing structure changed: offsetof(Thing, _stamina)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _score_value)) {
      game_load_error = "thing structure changed: offsetof(Thing, _score_value)";
      return in;
    }
    in >> bits(tmp);
    ...
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _fall_ms)) {
      game_load_error = "thing structure changed: offsetof(Thing, _fall_ms)";
      return in;
    }
    in >> bits(tmp);
    if (tmp != offsetof(Thing, _lunge_ms)) {
      game_load_error = "thing structure changed: offsetof(Thing, _lunge_ms)";
      return in;
    }
    in >> bits(tmp);
...
auto game_load_last_config(const char *appdata) -> bool
{
  ...
  if (game->config.version != version) {
    if (sdl.window != nullptr) {
      ...
      sdl_msg_box("Config version change. Will need to reset config. Found version [%s]. Expected version [%s].", game->config.version.c_str(),
                  version.c_str());
    }
