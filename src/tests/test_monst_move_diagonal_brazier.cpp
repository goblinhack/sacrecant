...
[[nodiscard]] static auto test_monst_move_diagonal_brazier(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_monst_move_diagonal_brazier() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("monst_move_diagonal_brazier");

  test_callback_set(test, test_monst_move_diagonal_brazier);
