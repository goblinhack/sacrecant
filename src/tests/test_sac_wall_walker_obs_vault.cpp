...
[[nodiscard]] static auto test_sac_wall_walker_obs_vault(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_sac_wall_walker_obs_vault() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("sac_wall_walker_obs_vault");

  test_callback_set(test, test_sac_wall_walker_obs_vault);
