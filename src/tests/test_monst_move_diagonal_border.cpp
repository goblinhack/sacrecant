...
[[nodiscard]] static auto test_monst_move_diagonal_border(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_monst_move_diagonal_border() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("monst_move_diagonal_border");

  test_callback_set(test, test_monst_move_diagonal_border);
