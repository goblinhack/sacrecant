...
[[nodiscard]] static auto test_beam_weapon_door_secret(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_beam_weapon_door_secret() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("beam_weapon_door_secret");

  test_callback_set(test, test_beam_weapon_door_secret);
