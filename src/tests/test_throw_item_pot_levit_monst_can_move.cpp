...
[[nodiscard]] static auto test_throw_item_pot_levit_monst_can_move(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_throw_item_pot_levit_monst_can_move() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("throw_item_pot_levit_monst_can_move");

  // begin sort marker1 {
  test_callback_set(test, test_throw_item_pot_levit_monst_can_move);
  // end sort marker1 }
