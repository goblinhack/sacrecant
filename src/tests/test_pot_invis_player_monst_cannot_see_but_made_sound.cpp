...
[[nodiscard]] static auto test_pot_invis_player_monst_cannot_see_but_made_sound(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_pot_invis_player_monst_cannot_see_but_made_sound() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("pot_invis_player_monst_cannot_see_but_made_sound");

  // begin sort marker1 {
  test_callback_set(test, test_pot_invis_player_monst_cannot_see_but_made_sound);
  // end sort marker1 }
