...
[[nodiscard]] static auto test_monst_move_diagonal_barrel(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_monst_move_diagonal_barrel() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("monst_move_diagonal_barrel");

  // begin sort marker1 {
  test_callback_set(test, test_monst_move_diagonal_barrel);
  // end sort marker1 }
