...
[[nodiscard]] static auto test_monst_amphibian(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_monst_amphibian() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("monst_amphibian");

  // begin sort marker1 {
  test_callback_set(test, test_monst_amphibian);
  // end sort marker1 }
