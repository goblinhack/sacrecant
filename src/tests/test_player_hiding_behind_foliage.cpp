...
[[nodiscard]] static auto test_player_hiding_behind_foliage(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_player_hiding_behind_foliage() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("player_hiding_behind_foliage");

  // begin sort marker1 {
  test_callback_set(test, test_player_hiding_behind_foliage);
  // end sort marker1 }
