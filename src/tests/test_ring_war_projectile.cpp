...
[[nodiscard]] static auto test_ring_war_projectile(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
  ...
  tp_beam_of_energy = tp_find_mand("proj_energy");
...
[[nodiscard]] auto test_load_ring_war_projectile() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("ring_war_projectile");

  test_callback_set(test, test_ring_war_projectile);
