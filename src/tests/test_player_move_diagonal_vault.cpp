...
[[nodiscard]] static auto test_player_move_diagonal_vault(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_player_move_diagonal_vault() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("player_move_diagonal_vault");

  test_callback_set(test, test_player_move_diagonal_vault);
