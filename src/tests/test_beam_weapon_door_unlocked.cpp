...
[[nodiscard]] static auto test_beam_weapon_door_unlocked(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_beam_weapon_door_unlocked() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("beam_weapon_door_unlocked");

  test_callback_set(test, test_beam_weapon_door_unlocked);
