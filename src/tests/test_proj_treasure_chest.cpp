...
[[nodiscard]] static auto test_proj_treasure_chest(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_proj_treasure_chest() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("proj_treasure_chest");

  test_callback_set(test, test_proj_treasure_chest);
