...
[[nodiscard]] static auto test_pot_levit_player_grass(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_pot_levit_player_grass() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("pot_levit_player_grass");

  test_callback_set(test, test_pot_levit_player_grass);
