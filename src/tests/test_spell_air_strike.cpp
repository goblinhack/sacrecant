...
[[nodiscard]] static auto test_spell_air_strike(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
  ...
  spell = thing_spawn(g, v, l, tp_find_mand("spell_air_strike"), thing_at(g, v, l, player));
  ...
  e.spell_info.option_name = "targeted air strike";
...
[[nodiscard]] auto test_load_spell_air_strike() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("spell_air_strike");

  test_callback_set(test, test_spell_air_strike);
