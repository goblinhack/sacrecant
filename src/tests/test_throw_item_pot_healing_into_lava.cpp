...
[[nodiscard]] static auto test_throw_item_pot_healing_into_lava(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_throw_item_pot_healing_into_lava() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("throw_item_pot_healing_into_lava");

  // begin sort marker1 {
  test_callback_set(test, test_throw_item_pot_healing_into_lava);
  // end sort marker1 }
