...
[[nodiscard]] static auto test_throw_item_pot_incin_chain_explosion(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_throw_item_pot_incin_chain_explosion() -> bool // NOLINT
{
  TRACE();

  Testp test = test_load("throw_item_pot_incin_chain_explosion");

  test_callback_set(test, test_throw_item_pot_incin_chain_explosion);
