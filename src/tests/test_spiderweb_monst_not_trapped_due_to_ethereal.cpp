...
[[nodiscard]] static auto test_spiderweb_monst_not_trapped_due_to_ethereal(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
...
[[nodiscard]] auto test_load_spiderweb_monst_not_trapped_due_to_ethereal() -> bool // NOLINT
{
  TRACE();
