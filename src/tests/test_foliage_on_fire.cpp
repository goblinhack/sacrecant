...
[[nodiscard]] static auto test_foliage_on_fire(Gamep g, Testp t) -> bool
{
  TEST_LOG(t, "begin");
  TRACE();
  ...
  //
  if (thing_spawn(g, v, l, tp_first(is_fire_normal), thing_at(g, v, l, player) + bpoint(2, 0)) == nullptr) {
...
[[nodiscard]] auto test_load_foliage_on_fire() -> bool // NOLINT
{
  TRACE();
