...
static void wid_spell_options_mouse_over_begin(Gamep g, Widp w, int /*relx*/, int /*rely*/, int /*wheelx*/, int /*wheely*/)
{
  TRACE();
...
static void wid_spell_options_mouse_over_end(Gamep g, Widp w)
{
  TRACE();
