...
auto level_is_health_visible(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_level_locked_icon(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_level_locked_icon, p, me);
}

auto level_is_level_closed_icon(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_stamina_visible(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_stamina_visible, p, me);
}

auto level_is_reeds(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_biome_graveyard(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_biome_graveyard, p, me);
}

auto level_is_biome_nethervoid(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_biome_nethervoid, p, me);
}

auto level_is_biome_bogland(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_biome_bogland, p, me);
}

auto level_is_biome_dungeon(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_biome_dungeon, p, me);
}

auto level_is_level_open_icon(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_level_open_icon, p, me);
}

auto level_is_blit_bg(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_blit_bg, p, me);
}

auto level_is_level_select_bg(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
  return level_flag(g, v, l, is_level_select_bg, p, me);
}

auto level_is_blit_hit_outline_w_black_inside(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
...
auto level_is_blit_hit_outline_w_invis_inside(Gamep g, Levelsp v, Levelp l, const bpoint &p, Thingp me) -> Thingp
{
  TRACE_DEBUG();
