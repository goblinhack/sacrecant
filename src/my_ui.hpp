...
#define UI_INFO1_FMT_STR     "%%fg=gray90$"
#define UI_INFO2_FMT_STR     "%%fg=grayblue$"
#define UI_INFO3_FMT_STR     "%%fg=gray90$"
#define UI_INFO4_FMT_STR     "%%fg=grayblue$"
...
#define UI_WARN_FMT_STR      "%%fg=yellow$"
...
enum {
  ...
  UI_WID_STYLE_BUTTON_ROUNDED_SOLID,
  UI_WID_STYLE_BUTTON_BAR,
  UI_WID_STYLE_BUTTON_UNUSED2,
  UI_WID_STYLE_BUTTON_OUTLINE,
  UI_WID_STYLE_CONSOLE,
  UI_WID_STYLE_BUTTON_ROUNDED_SOLID_MOUSE_OVER,
  UI_WID_STYLE_BUTTON_OUTLINE_MOUSE_OVER,
  UI_WID_STYLE_BUTTON_SQUARE_SOLID,
