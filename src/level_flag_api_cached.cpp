...
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_wall_walker, p);
}
...
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_critical_to_dungeon_design, p);
}
...
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_unused_spell, p);
}
...
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_wall_walker_pass_through, p);
}

[[nodiscard]] auto level_is_obs_to_wall_walker_cached(Gamep g, Levelsp v, Levelp l, const bpoint &p) -> bool
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_obs_to_wall_walker, p);
}
...
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_weaponless_on_spawn, p);
}
...
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_debuff, p);
}
...
{
  TRACE_DEBUG();
  return level_flag_cached(g, v, l, is_critical_to_gameplay, p);
}
