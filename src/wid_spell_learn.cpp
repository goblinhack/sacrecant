...
[[nodiscard]] static auto wid_spell_learn_stats_arcana_pyro_mouse_down(Gamep g, Widp w, int x, int y, uint32_t button) -> bool
{
  TRACE();
  ...
  if (wid_spell_filter == THING_STAT_ARCANA_PYRO) {
    ...
    wid_spell_learn(g, v, l, player, THING_STAT_ARCANA_PYRO);
  }

  return true;
}

[[nodiscard]] static auto wid_spell_learn_stats_arcana_geo_mouse_down(Gamep g, Widp w, int x, int y, uint32_t button) -> bool
{
  TRACE();
  ...
  if (wid_spell_filter == THING_STAT_ARCANA_GEO) {
    ...
    wid_spell_learn(g, v, l, player, THING_STAT_ARCANA_GEO);
  }

  return true;
}

[[nodiscard]] static auto wid_spell_learn_stats_arcana_bio_mouse_down(Gamep g, Widp w, int x, int y, uint32_t button) -> bool
{
  TRACE();
  ...
  if (wid_spell_filter == THING_STAT_ARCANA_BIO) {
    ...
    wid_spell_learn(g, v, l, player, THING_STAT_ARCANA_BIO);
  }

  return true;
}

[[nodiscard]] static auto wid_spell_learn_stats_arcana_necro_mouse_down(Gamep g, Widp w, int x, int y, uint32_t button) -> bool
{
  TRACE();
  ...
  if (wid_spell_filter == THING_STAT_ARCANA_NECRO) {
    ...
    wid_spell_learn(g, v, l, player, THING_STAT_ARCANA_NECRO);
  }

  return true;
}

static void wid_spell_learn_stats_arcana_pyro_mouse_over_begin(Gamep g, Widp w, int /*relx*/, int /*rely*/, int /*wheelx*/, int /*wheely*/)
{
  TRACE();
...
static void wid_spell_learn_stats_arcana_geo_mouse_over_begin(Gamep g, Widp w, int /*relx*/, int /*rely*/, int /*wheelx*/, int /*wheely*/)
{
  TRACE();
...
static void wid_spell_learn_stats_arcana_bio_mouse_over_begin(Gamep g, Widp w, int /*relx*/, int /*rely*/, int /*wheelx*/, int /*wheely*/)
{
  TRACE();
...
static void wid_spell_learn_stats_arcana_necro_mouse_over_begin(Gamep g, Widp w, int /*relx*/, int /*rely*/, int /*wheelx*/, int /*wheely*/)
{
  TRACE();
...
void wid_spell_learn(Gamep g, Levelsp v, Levelp l, Thingp player, ThingStatType filter)
{
  ...
  //
  {
    ...
    wid_set_pos(w, tl, br);
    wid_set_text(w, UI_INFO_FMT_STR "Spell name                    Arcana       SP Cost");
    y_at++;
  }
  ...
  //
  {
    ...
    auto        *w   = wid_new_bright_button(g, wid_spell_learn_window, stat_to_name_short(THING_STAT_ARCANA_PYRO));
    spoint const tl(10, y_at);
    spoint const br(18, y_at + 2);
    wid_set_pos(w, tl, br);
    wid_set_text(w, out);
    wid_set_on_mouse_down(w, wid_spell_learn_stats_arcana_pyro_mouse_down);
    if (filter == THING_STAT_ARCANA_PYRO) {
      ...
      wid_set_on_mouse_over_begin(w, wid_spell_learn_stats_arcana_pyro_mouse_over_begin);
  ...
  }
  {
    ...
    auto        *w   = wid_new_bright_button(g, wid_spell_learn_window, stat_to_name_short(THING_STAT_ARCANA_GEO));
    spoint const tl(19, y_at);
    spoint const br(27, y_at + 2);
    wid_set_pos(w, tl, br);
    wid_set_text(w, out);
    wid_set_on_mouse_down(w, wid_spell_learn_stats_arcana_geo_mouse_down);
    if (filter == THING_STAT_ARCANA_GEO) {
      ...
      wid_set_on_mouse_over_begin(w, wid_spell_learn_stats_arcana_geo_mouse_over_begin);
      wid_set_on_mouse_over_end(w, wid_spell_learn_stats_mouse_over_end);
    }
  }
  {
    auto         out = thing_stat_mod_string(g, v, l, player, THING_STAT_ARCANA_BIO);
    auto        *w   = wid_new_bright_button(g, wid_spell_learn_window, stat_to_name_short(THING_STAT_ARCANA_BIO));
    spoint const tl(28, y_at);
    spoint const br(36, y_at + 2);
    wid_set_pos(w, tl, br);
    wid_set_text(w, out);
    wid_set_on_mouse_down(w, wid_spell_learn_stats_arcana_bio_mouse_down);
    if (filter == THING_STAT_ARCANA_BIO) {
      ...
      wid_set_on_mouse_over_begin(w, wid_spell_learn_stats_arcana_bio_mouse_over_begin);
      wid_set_on_mouse_over_end(w, wid_spell_learn_stats_mouse_over_end);
    }
  }
  {
    auto         out = thing_stat_mod_string(g, v, l, player, THING_STAT_ARCANA_NECRO);
    auto        *w   = wid_new_bright_button(g, wid_spell_learn_window, stat_to_name_short(THING_STAT_ARCANA_NECRO));
    spoint const tl(37, y_at);
    spoint const br(45, y_at + 2);
    wid_set_pos(w, tl, br);
    wid_set_text(w, out);
    wid_set_on_mouse_down(w, wid_spell_learn_stats_arcana_necro_mouse_down);
    if (filter == THING_STAT_ARCANA_NECRO) {
      ...
      wid_set_on_mouse_over_begin(w, wid_spell_learn_stats_arcana_necro_mouse_over_begin);
      wid_set_on_mouse_over_end(w, wid_spell_learn_stats_mouse_over_end);
    }
  }
