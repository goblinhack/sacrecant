...
[[nodiscard]] auto thing_mana_max_incr(Gamep g, Levelsp v, Levelp l, Thingp t, int val = 1) -> int;
...
[[nodiscard]] auto thing_spell_radius_incr(Gamep g, Levelsp v, Levelp l, Thingp t, int val = 1) -> int;
...
[[nodiscard]] auto thing_spell_radius_set(Gamep g, Levelsp v, Levelp l, Thingp t, int val) -> int;
[[nodiscard]] auto thing_spell_radius(Gamep g, Levelsp v, Levelp l, Thingp me) -> int;
[[nodiscard]] auto thing_spell_radius(Gamep g, Levelsp v, Levelp l, Thingp t) -> int;
...
[[nodiscard]] auto thing_spell_range_set(Gamep g, Levelsp v, Levelp l, Thingp t, int val) -> int;
[[nodiscard]] auto thing_spell_range(Gamep g, Levelsp v, Levelp l, Thingp me) -> int;
[[nodiscard]] auto thing_spell_range(Gamep g, Levelsp v, Levelp l, Thingp t) -> int;
