...
#define THING_FLAG_ENUM(list_macro)                                                                                                             \
  ...
  list_macro(is_able_to_be_buffed, "is_able_to_be_buffed"),                                 /* newline */                                       \
      ...
      list_macro(is_able_to_jump_land_then_pounce, "is_able_to_jump_land_then_pounce"),     /* newline */                                       \
...
#define THING_STAT_ENUM(list_macro)                                                                                                             \
  CLANG_FORMAT_INDENT()                                  /* dummy line for clang indentation fixup */                                           \
  list_macro(THING_STAT_NONE, "none"),                   /* newline */                                                                          \
      ...
      list_macro(THING_STAT_ARCANA_PYRO, "pyromancy"),   /* newline */                                                                          \
      list_macro(THING_STAT_ARCANA_BIO, "biomancy"),     /* newline */                                                                          \
      list_macro(THING_STAT_ARCANA_NECRO, "necromancy"), /* newline */                                                                          \
      list_macro(THING_STAT_ARCANA_GEO, "geomancy"),     /* newline */
