...
[[nodiscard]] WidPopup *wid_arcana_pyro_mouse_over_begin(Gamep g);
[[nodiscard]] WidPopup *wid_arcana_geo_mouse_over_begin(Gamep g);
[[nodiscard]] WidPopup *wid_arcana_bio_mouse_over_begin(Gamep g);
[[nodiscard]] WidPopup *wid_arcana_necro_mouse_over_begin(Gamep g);
