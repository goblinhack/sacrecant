...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_able_to_be_teleported, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_unused120, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_unused124, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_wooden_leg, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_boost, p);
}
...
{
  TRACE_DEBUG();
  return level_count(g, v, l, is_able_to_be_levitated, p);
}
